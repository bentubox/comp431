...
import { addArticle, addTextOnlyArticle } from './mainActions'

const Post = ({user, addArticle, addTextOnlyArticle}) => {
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        addTextOnlyArticle: (textInput) => {
            addTextOnlyArticle(textInput.value)(fn => fn((action) => {
                dispatch(action)
            }))
        }
    }
